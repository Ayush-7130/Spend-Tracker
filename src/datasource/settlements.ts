...
export class SettlementsDataSource {
  ...
  static async getSettlements(
    ...
    return withRetry(() =>
      api.get<SettlementListResponse>("/settlements", filters)
    );
  }
  ...
  static async createSettlement(
    ...
    return withRetry(() =>
      api.post<Settlement>("/settlements", settlementData)
    );
  }
  ...
  static async updateSettlement(
    ...
    return withRetry(() =>
      api.put<Settlement>(`/settlements/${id}`, settlementData)
    );
  }
  ...
  static async deleteSettlement(
    ...
    return withRetry(() =>
      api.delete<{ success: boolean; message: string }>(`/settlements/${id}`)
    );
  }
  ...
  static async completeSettlement(id: string): Promise<Settlement> {
    return withRetry(() =>
      api.patch<Settlement>(`/settlements/${id}/complete`)
    );
  }
   ...
   */
  static async getSettlementSuggestions(): Promise<
    Array<{
      fromUser: string;
      toUser: string;
      amount: number;
   ...
   */
  static async getOptimalSettlementPlan(): Promise<
    Array<{
      fromUser: string;
      toUser: string;
      amount: number;
